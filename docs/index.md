# AarogyaRekha Project Hub

!!! abstract "Project Goal"
    Transforming fragmented medical paper records into a structured, searchable, and intelligent health dashboard.

---

## 🏗️ Project Architecture

We have split the development into two core tracks. Select a track below to view tasks, documentation, and progress.

<div class="grid cards" markdown>

-   :material-database:{ .lg .middle } __Backend Development__
    ---
